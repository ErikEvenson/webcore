...
```
  ...
  sudo npm -g install bower@1.3.12 coffee-script@1.8.0 generator-angular-fullstack@2.0.13 grunt-cli@0.1.13 npm-check-updates@1.2.0 npm-install-missing@0.1.4
```
...
- Force SSL per bb6e3bef35dcdc88ad0540a4375161ea950f445b
